							...
							<div className="row row-grid">
								...
								<div className="col-md-6 col-lg-4 col-xl-3">
									<div className="profile-widget">
										<div className="doc-img">
											<Link to="/patient/doctor-profile">
												<img className="img-fluid" alt="User" src="assets/img/doctors/doctor-10.jpg" />
											</Link>
											<a href="#0" className="fav-btn">
												<i className="far fa-bookmark"></i>
											</a>
								...
								<div className="col-md-6 col-lg-4 col-xl-3">
									<div className="profile-widget">
										<div className="doc-img">
											<Link to="/patient/doctor-profile">
												<img className="img-fluid" alt="User" src="assets/img/doctors/doctor-11.jpg" />
											</Link>
											<a href="#0" className="fav-btn">
												<i className="far fa-bookmark"></i>
											</a>
								...
								<div className="col-md-6 col-lg-4 col-xl-3">
									<div className="profile-widget">
										<div className="doc-img">
											<Link to="/patient/doctor-profile">
												<img className="img-fluid" alt="User" src="assets/img/doctors/doctor-12.jpg" />
											</Link>
											<a href="#0" className="fav-btn">
												<i className="far fa-bookmark"></i>
											</a>
